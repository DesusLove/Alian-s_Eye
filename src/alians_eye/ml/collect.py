...
from alians_eye.core.config import DEFAULT_HEADERS, ScannerConfig
from alians_eye.core.detector import Detector
from alians_eye.core.features import FEATURE_SCHEMA, vectorize_features
from alians_eye.core.http import fetch_url
from alians_eye.core.rate_limit import DomainRateLimiter
from alians_eye.core.scanner import format_site_url


def load_selfcheck_data() -> dict[str, list[str]]:
    """Map of site name to usernames known to exist there."""
    text = (resources.files("alians_eye.data") / "selfcheck.json").read_text("utf-8")
