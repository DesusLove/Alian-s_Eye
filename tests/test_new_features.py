...
from alians_eye.core import report as report_mod
from alians_eye.core.checkpoint import Checkpoint
from alians_eye.core.correlate import (
    Profile,
    cluster_profiles,
    profiles_from_report,
)
from alians_eye.core.domains import domain_label
from alians_eye.core.expand import candidate_usernames_from_results
from alians_eye.core.exporter import ResultsExporter
from alians_eye.ml.collect import write_rows
from alians_eye.selfcheck import _metrics
...
def test_write_rows_append(tmp_path):
    from alians_eye.core.features import FEATURE_SCHEMA
