...
from alians_eye.ml.train import load_dataset

sklearn = pytest.importorskip("sklearn")

from alians_eye.ml.inference import MLModel  # noqa: E402
from alians_eye.ml.train import train_model  # noqa: E402
